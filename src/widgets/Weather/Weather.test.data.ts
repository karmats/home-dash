export const generateSmhiData = (mainTemp = 2.5) => ({
  ...
  timeSeries: [
    ...
    {
      validTime: '2019-02-18T09:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T10:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T11:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T12:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T13:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T14:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T15:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T16:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T17:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T18:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
    ...
    {
      validTime: '2019-02-18T19:00:00Z',
      parameters: [
        {
          name: 'pmean',
          unit: 'kg/m2/h',
